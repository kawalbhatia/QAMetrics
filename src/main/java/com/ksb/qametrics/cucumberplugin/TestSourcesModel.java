...
//		System.out.println("==========ksb====="+calculateId(candidate));
//		
//		System.out.println(candidate.parent.node.getClass());
//		System.out.println((Scenario) candidate.node);
//		
		return candidate == null ? null : (Scenario) candidate.node;
	}

	static boolean isBackgroundStep(AstNode astNode) {
	//	System.out.println("==========ksb====="+(Scenario) candidate.node);
		//astNode.parent.node instanceof Background
	...
	static String calculateId(AstNode astNode) {
		...
		if (node instanceof Scenario) {
			System.out.println(calculateId(astNode.parent) + ";" + convertToId(((Scenario) node).getName()));
	...
	static URI relativize(URI uri) {
		...
		if (!uri.isAbsolute()) {
		//	System.out.println("absoluteuri=="+uri);
			return uri;
		}
		...
		//	System.out.println("relative=="+root.relativize(uri));
	...
	void addTestSourceReadEvent(URI path, TestSourceRead event) {
		...
		System.out.println("event uri=>"+event.getUri());
